...
export const TreatmentPackagesModal: React.FC<TreatmentPackagesModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[92vh] overflow-y-auto shadow-xl border border-slate-200/90 animate-in zoom-in-95 duration-150 flex flex-col">
