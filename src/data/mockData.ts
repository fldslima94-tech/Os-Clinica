...
export const MOCK_USUARIOS: UsuarioEquipe[] = [
  ...
  {
    id: 'user-gestor-camila',
    nome: 'Dra. Camila Vasconcelos',
    nomeCompleto: 'Dra. Camila Vasconcelos',
    email: 'gestor@auraestetica.com.br',
    senha: 'gestor123',
    cargo: 'Admin Local (Gestor)',
    profissao: 'Biomédica Esteta & Gestora da Unidade',
    role: 'admin_local',
    telefone: '(11) 98111-2244',
    status: 'ativo',
    ultimo_acesso: 'Online agora',
    avatar_url: 'https://images.unsplash.com/photo-1594824813627-80f089601a41?w=400&auto=format&fit=crop&q=80',
    registro_profissional: 'CRBM/SP 44.891',
    especialidade: 'Harmonização Facial & Cosmiatria Avançada',
...
export const MOCK_PROCEDIMENTOS: ProcedimentoClinico[] = [
  {
    ...
    profissional_id: 'user-gestor-camila',
    profissional_nome: 'Dra. Camila Vasconcelos',
    descricao: 'Revitalização e definição labial com efeito translúcido e natural, corrigindo assimetrias e tons pálidos.',
    ...
    imagens_galeria: [
      ...
      'https://images.unsplash.com/photo-1588516903720-8ceb67f9ef84?w=600&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    profissional_id: 'user-gestor-camila',
    profissional_nome: 'Dra. Camila Vasconcelos',
    descricao: 'Aplicação fio a fio e leques ultraleves para curvatura, volume e olhar marcante sem necessidade de rímel.',
    areas_aplicacao: ['Olhos / Cílios Superiores'],
    indicacoes: ['Cílios curtos ou ralos', 'Realce do olhar', 'Praticidade diária'],
    custo_estimado_insumos: 35,
    margem_lucro_estimada: 185,
    exige_contrato: true,
    ativo: true,
    destaque_portal: true,
    imagem_url: 'https://images.unsplash.com/photo-1583001931096-959e9a1a6223?w=600&auto=format&fit=crop&q=80',
    imagens_galeria: [
      'https://images.unsplash.com/photo-1583001931096-959e9a1a6223?w=600&auto=format&fit=crop&q=80',
  ...
  {
    id: 'proc-03',
    nome: 'Design de Sombrancelhas com Henna & Alinhamento',
    ...
    profissional_id: 'user-gestor-camila',
    profissional_nome: 'Dra. Camila Vasconcelos',
    descricao: 'Mapeamento facial personalizado, epilação na linha ou pinça e pigmentação natural com henna orgânica.',
    areas_aplicacao: ['Sombrancelhas'],
    indicacoes: ['Falhas nas sobrancelhas', 'Definição do desenho', 'Harmonização facial'],
    custo_estimado_insumos: 15,
    margem_lucro_estimada: 70,
    ...
    imagens_galeria: [
      'https://images.unsplash.com/photo-1512290900672-1f02e6005b4b?w=600&auto=format&fit=crop&q=80',
      'https://images.unsplash.com/photo-1588516903720-8ceb67f9ef84?w=600&auto=format&fit=crop&q=80'
    ],
    criado_em: '2025-01-01T00:00:00Z',
  },
  {
    ...
    profissional_id: 'user-01',
    profissional_nome: 'Dra. Camila Vasconcelos',
    descricao: 'Higienização profunda, vapor de ozônio, extração indolor com espátula ultrassônica, alta frequência e máscara calmante.',
    areas_aplicacao: ['Face Completa', 'Pescoço'],
    indicacoes: ['Cravos e miliuns', 'Controle da oleosidade', 'Renovação celular'],
    custo_estimado_insumos: 30,
    margem_lucro_estimada: 160,
    exige_contrato: true,
    ativo: true,
    destaque_portal: true,
  ...
  },
  {
    ...
    profissional_id: 'user-gestor-camila',
    profissional_nome: 'Dra. Camila Vasconcelos',
    descricao: 'Desintoxicação do couro cabeludo, reposição de massa lipídica e selagem térmica com brilho intenso.',
    areas_aplicacao: ['Couro Cabeludo', 'Comprimento e Pontas'],
    indicacoes: ['Fios ressecados', 'Queda e enfraquecimento', 'Recuperação pós-química'],
    custo_estimado_insumos: 45,
    margem_lucro_estimada: 205,
    exige_contrato: false,
    ativo: true,
    destaque_portal: true,
    imagem_url: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=600&auto=format&fit=crop&q=80',
    imagens_galeria: [
  ...
  {
    id: 'proc-06',
    nome: 'Penteado Social / Noiva / Eventos',
    categoria: 'penteado',
    duracao_minutos: 60,
    valor_tabela: 180,
    quantidade_sessoes: 1,
    profissional_id: 'user-gestor-camila',
    profissional_nome: 'Dra. Camila Vasconcelos',
    descricao: 'Penteados clássicos, tranças estilizadas, coques despojados e semipresos para formaturas, festas e ocasiões especiais.',
    areas_aplicacao: ['Cabelos'],
    indicacoes: ['Eventos e festas', 'Casamentos e noivas', 'Ensaios fotográficos'],
    custo_estimado_insumos: 25,
    margem_lucro_estimada: 155,
    exige_contrato: false,
    ativo: true,
    destaque_portal: true,
    imagem_url: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=600&auto=format&fit=crop&q=80',
    imagens_galeria: [
      'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=600&auto=format&fit=crop&q=80'
    ],
    criado_em: '2025-01-01T00:00:00Z',
  ...
  {
    id: 'proc-07',
    nome: 'Drenagem Linfática & Procedimento Estético',
    ...
    profissional_id: 'user-01',
    profissional_nome: 'Dra. Camila Vasconcelos',
    descricao: 'Manobras suaves e ritmadas para redução de retenção hídrica, alívio de edemas e estímulo circulatório facial e corporal.',
    areas_aplicacao: ['Face e Corpo'],
    indicacoes: ['Retenção de líquidos', 'Pós-operatório tardio', 'Sensação de inchaço'],
    custo_estimado_insumos: 20,
    margem_lucro_estimada: 130,
    exige_contrato: true,
    ativo: true,
    destaque_portal: true,
    imagem_url: 'https://images.unsplash.com/photo-1519823551278-64ac92734fb1?w=600&auto=format&fit=crop&q=80',
    imagens_galeria: [
...
export const MOCK_ESTOQUE: EstoqueInsumo[] = [
  {
    ...
    cor: 'Velvet Red / Vermelho Carmim Suave',
