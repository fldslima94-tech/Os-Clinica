...
export const MOCK_USUARIOS: UsuarioEquipe[] = [
  ...
  },
  {
    ...
    status: 'ativo',
    ultimo_acesso: 'Hoje às 10:20',
    avatar_url: 'https://images.unsplash.com/photo-1594824813693-8a30dbf20387?w=400&auto=format&fit=crop&q=80',
    registro_profissional: 'CRBM/SP 34.810',
    especialidade: 'Injetáveis, Toxina & Bioestimuladores',
    porcentagem_comissao: 40,
    permissoes: {
  ...
  },
  {
    ...
    registro_profissional: 'Esteticista Reg. 8921/SP',
    especialidade: 'Micropigmentação Labial, Fio a Fio & Sobrancelhas',
    porcentagem_comissao: 45,
    permissoes: {
      ver_financeiro_completo: false,
      emitir_recibo: true,
      editar_prontuario_clinico: true,
